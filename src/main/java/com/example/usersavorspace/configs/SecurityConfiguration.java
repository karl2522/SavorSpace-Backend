...
public class SecurityConfiguration {
    ...
    public UserDetailsService securityUserDetailsService() {
        UserDetails admin = User.withUsername("admin")
                .password(securityPasswordEncoder().encode("adminpassword"))
                .roles("ADMIN")
                .build();
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/**", "/api/admins/register", "/api/admins/**").permitAll() // Allow admin registration and access to all admin endpoints
